...
import type { RequestWithUser, TokenVersion, User } from "../interfaces/user.interface.js";
...
export const authMiddleware = async (req: RequestWithUser, res: Response, next: NextFunction) => {
    try {
        ...
        const { _id, tokenVersion } = jwt.verify(authorization, JWT_SECRET as string) as TokenVersion;
